package com.sabbirosa.vangtichai.components
...
@Composable
fun PortraitNumpad(width: Dp, onNumClick: (Int) -> Unit, onClearClick: () -> Unit) {
    Box(
        modifier = Modifier
            .layoutId("numpadBox")
            .width(width)
...
@Composable
fun LandscapeNumpad(width: Dp, onNumClick: (Int) -> Unit, onClearClick: () -> Unit) {
    Box(
        modifier = Modifier
            .layoutId("numpadBox")
            .width(width)
